(function() {
    ...
    function VelocityScene() {
        ...
        var letters = [], text = 'ALLISON\'S THE BOMB';
        ...
        this.beginAnimation = function() {
            ...
            $l1outer.css({overflow: 'hidden', width: 700, height: 12, left: '50%', marginLeft: -300, top: '50%',
                          marginTop: -5, transform: $l1outer.transform({x: 250, y: 0}) });
            $l1inner.css({width: 700, height: 10, top: 1, transform: $l1inner.transform({x: -500, y: 0}), background: Colors.white});
            $l2.css({width: 700, height: 10, left: '50%', marginLeft: -300, top: '53%', marginTop: -4,
                background: Colors.white, display: 'none', transform: $l2.transform({skewY: -9})});
            $text.css({width: 1200, height: 10, fontSize: 100, color: Colors.white, left: '50%', marginLeft: -456,
    ...
    function VelocityMask() {
        ...
        function initElements() {
            $text = createDiv('text');
            $text.css({width: 1200, height: 160, fontSize: 100, color: Colors.blue, left: '50%', marginLeft: -456,
